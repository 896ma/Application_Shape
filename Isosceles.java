...
// Class representing an isosceles shape

class Isosceles extends HollowPolygon {

    // Constructor that calls super constructor

    public Isosceles(Color color, Point point, int height, int width) {
        super(color, 3);
        int[] x_points = { point.x, point.x - width/2, point.x + width/2 };
        int[] y_points = { point.y, point.y + height, point.y + height };
